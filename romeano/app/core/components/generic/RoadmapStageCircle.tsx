...
export function RoadmapStageCircle({ stageNum, status }: { stageNum: number; status: CompletionStatus }) {
  switch (status) {
    case CompletionStatus.Complete:
      return (
        <div>
          ...
          <div className="group relative w-16 h-16 flex items-center justify-center bg-white border-2 border-green-600 rounded-full hover:border-green-900">
            <span className="text-green-600 text-2xl group-hover:text-green-900">{stageNum}</span>
          </div>
        </div>
      )
      ...
      return (
        <>
          ...
          <div className="group relative w-16 h-16 flex items-center justify-center bg-white border-2 border-gray-300 rounded-full hover:border-gray-400">
            <span className="text-2xl text-gray-400 group-hover:text-gray-600">{stageNum}</span>
          </div>
        </>
      )
  }
